...
public class MiniCParser extends Parser {
	...
	public static final int
		...
		RULE_typeSpecifier = 4, RULE_functionDeclaration = 5, RULE_functionDefinition = 6, 
		RULE_parameterList = 7, RULE_parameter = 8, RULE_compoundStatement = 9, 
		RULE_statement = 10, RULE_ifStatement = 11, RULE_whileStatement = 12, 
		RULE_forStatement = 13, RULE_forInit = 14, RULE_forUpdate = 15, RULE_doWhileStatement = 16, 
		RULE_assignmentStatement = 17, RULE_returnStatement = 18, RULE_expressionStatement = 19, 
		...
		RULE_multiplicativeExpression = 26, RULE_unaryExpression = 27, RULE_postfixExpression = 28, 
		RULE_primaryExpression = 29, RULE_callExpression = 30, RULE_argumentList = 31, 
		RULE_lvalue = 32;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"compoundStatement", "statement", "ifStatement", "whileStatement", "forStatement", 
			"forInit", "forUpdate", "doWhileStatement", "assignmentStatement", "returnStatement", 
